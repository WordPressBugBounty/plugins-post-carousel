...
const dynamicCss = (attributes, page = "frontend", currentDevice = "all") => {
	...
	const responsiveCss = (deviceType) => {
		return [
			{
				class: `#${uniqueId} .post-timeline-two .sp-smart-post-card .sp-smart-post-template-one-content`,
				styles: {
	...
	const timelineCss = [
		...
		{
			class: `#${uniqueId} .sp-smart-post-timeline-container .sp-smart-post-timeline-one-post-container:first-child .sp-smart-indicator-circle, #${uniqueId} .sp-smart-post-timeline-container .sp-smart-post-timeline-one-post-container:nth-child(${
				smallItemHeight.device.Desktop !== "" ? "1" : "2"
		...
		},
		{
			...
			#${uniqueId} .sp-smart-post-timeline-container .sp-smart-post-timeline-one-post-container:nth-child(${
				smallItemHeight.device.Desktop !== "" ? "1" : "2"
	...
	const desktopCss = [
		...
		{
			class: `#${uniqueId} .post-timeline-two .sp-smart-post-timeline-container`,
			styles: {
