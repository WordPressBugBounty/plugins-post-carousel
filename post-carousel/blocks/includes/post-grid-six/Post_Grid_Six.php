...
/**
 * Post Grid Six Block Class.
 */
class Post_Grid_Six extends Block_Base {
	/**
	...
	/**
	 * Render the Post Grid Six block.
	 *
	...
	public function render_block( $attributes, $content = '', $blocks = array() ) {
		...
		?>
			...
			<div class="sp-smart-post-show-pro-pre-query">
				...
				<div class="sp-smart-show-pro grid-six-container sp-smart-post-items">
					<?php
					Template::post_grid_six( $attributes, $post_query );
					?>
				</div>
				<?php
				// Pagination.
