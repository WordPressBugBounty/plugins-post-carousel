<?php
/**
 * Timeline two block attributes file class for Smart Post Show Blocks.
 *
...
$post_timeline_two_attributes = array(
...
return array_merge( $post_timeline_two_attributes, $shared_attributes );
